...
namespace NZWalks.Controllers
{
    ...
    public class WalksController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<WalkDto>>> GetAllWalk([FromQuery] string? filterOn, [FromQuery]string? filterQuery, [FromQuery]string? sortBy, [FromQuery]bool? isAscending, [FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 1000)
        {
        ...
        [Route("{id:Guid}")]
        [ValidateModel]
        public async Task<ActionResult<WalkDto>> UpdateWalk([FromRoute] Guid id, [FromBody] UpdateWalkRequestDto updateWalkRequestDto)
        {
